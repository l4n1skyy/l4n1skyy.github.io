export const projects = [
  // pengyou
  {
    ...
    title: 'PengYou',
    status: 'Completed',
    statusColor: 'bg-pink-400/10 text-pink-400',
    date: 'June 2024',
    links: [
      { label: 'test app', url: 'https://pengyou.vercel.app/' },
      { label: 'github repo', url: 'https://github.com/Spimy/pengyou' },
      { label: 'linkedin post', url: 'https://www.linkedin.com/posts/alexcheekaihong_imaginehack2024-activity-7205937571774750720-TCng?utm_source=share&utm_medium=member_desktop' }
    ],
  ...
  // scholarfisch
  {
    ...
    date: 'December 2024',
    links: [
      { label: 'github repo', url: 'https://github.com/l4n1skyy/scholarfisch' }
    ],
  ...
  // cs50x
  {
    ...
    date: '2021 - 2022',
    links: [
      { label: 'cs50x 2021', url: 'https://cs50.harvard.edu/x/2021/' },
      { label: 'certificate', url: 'https://cs50.harvard.edu/certificates/6a1a1785-770e-4212-8921-2e67f8f3c44d' }
    ],
  ...
  // quantum entanglement
  {
    ...
    date: 'Aug 2023',
    links: [
      { label: 'github repo', url: 'https://github.com/mit-mit-randomprojectlab/team_myctl_pyweek33' },
      { label: 'youtube video', url: 'https://www.youtube.com/watch?v=5AHixv2CV7Q' },
      { label: 'pyweek rankings', url: 'https://pyweek.org/33/ratings/' }
    ],
  ...
  // toaddo
  {
    ...
    date: 'March 2024',
    links: [
      { label: 'test app', url: 'https://l4n1skyy.github.io/Toad-Do' },
      { label: 'github repo', url: 'https://github.com/l4n1skyy/Toad-Do' }
    ],
  ...
  // gdsc
  {
    ...
    date: 'July 2023',
    links: [
      { label: 'coursera.org/professional-certificates/google-data-analytics', url: 'https://www.coursera.org/professional-certificates/google-data-analytics' }
    ],
  ...
  // polybar ping
  {
    ...
    date: 'Aug 2023',
    links: [
      { label: 'github repo', url: 'https://github.com/l4n1skyy/polybar-ping' }
    ],
  ...
  // clinder
  {
    ...
    date: 'Aug 2023',
    links: [
      { label: 'github repo', url: 'https://github.com/l4n1skyy/clinder' }
    ],
  ...
  // personal website
  {
    ...
    date: '2021',
    links: [
      { label: 'test site', url: 'https://l4n1skyy.github.io' }
    ],
  ...
  {
    id: 'sppc',
    title: 'Sistem Pengurusan Pertandingan Catur (SPPC)',
    status: 'Completed',
    statusColor: 'bg-pink-400/10 text-pink-400',
    date: 'June 2022',
    links: [
      { label: 'github repo', url: 'https://github.com/l4n1skyy/SPPC' }
    ],
